...
//-------------------------------------------------Saving-----------------------------------------------------------------------------//
	...
	public static void saving(){
		L1:do{
			...
			System.out.println("\n");
			System.out.printf("\t\t\t\t The intrest you get per year  : %1.2f %n%n", intrPeryear);
			L2:do{
				System.out.print("\t Do you Want to Exit to Calculate another Saving? (Y/N) -> ");
	...
	public static void fixed(){
		L1:do{
			...
			System.out.printf("\t\t\t\t The intrest you get per month : %1.2f %n", intrPerMonth);
			System.out.println("\n");
			System.out.printf("\t\t\t\t Total amount at the end       : %1.2f %n%n", intrEnd);
			L2:do{
				System.out.print("\t Do you Want to Exit to Calculate another Another Fixed Deposit? (Y/N) -> ");
				char answer = input.next().toLowerCase().charAt(0);
				if(answer=='y'){
					continue L1;
				}else if(answer=='n'){
	...
	public static void deposit(){
		...
		System.out.println("\n");
		System.out.printf("\t\t\t\t %-15s %n", "[3] Main Menu");
		System.out.println("\n");
		int op;
			Scanner input = new Scanner(System.in);
...
//------------------------------------------------------Loan------------------------------------------------------------------------//
		...
		L1: do{
			...
			if (salary < 50000) {
				...
				if (amount > 200000 && months > 24) {
					...
					System.out.printf("\t\tyour Monthly instalment    : %1.2f %n%n", monIns2);
				}
			}
			L2:do{
				System.out.print("\t Do you Want to Exit to Calculate another Another Personal Loan? (Y/N) -> ");
				char answer = input.next().toLowerCase().charAt(0);
				if(answer=='y'){
					continue L1;
				}else if(answer=='n'){
		...
		L1: do{
			...
			if (bizIncome < 50000) {
				...
				if (bizAmount > 500000 && bizMonths > 36) {
					...
					System.out.printf("\t\tyour Monthly instalment    : %1.2f%n%n", bizMonIns2);
				}
			}
			L2:do{
				System.out.print("\t Do you Want to Exit to Calculate another Another Business Loan? (Y/N) -> ");
				char answer = input.next().toLowerCase().charAt(0);
				if(answer=='y'){
					continue L1;
				}else if(answer=='n'){
	...
	public static void  homeHquityLoan(){
		L1: do{
			clearConsole();
			Scanner input = new Scanner(System.in);
			...
			if (homeIncome < 50000) {
				...
				if (homeAmount > 500000 && homeMonths < 48) {
					...
					System.out.printf("\t\tyour Monthly instalment    : %1.2f%n%n", homeMonIns2);
				}
			}
			L2:do{
				System.out.print("\t Do you Want to Exit to Calculate another Another Home equity Loan? (Y/N) -> ");
				char answer = input.next().toLowerCase().charAt(0);
				if(answer=='y'){
					continue L1;
				}else if(answer=='n'){
	...
	public static void carFinance(){
		L1: do{		
			...
			System.out.printf("\t\tyour Monthly instalment      : %1.2f %n%n", vehMonIns);
			
			L2:do{
				System.out.print("\t Do you Want to Exit to Calculate another Another Car Finance Loan? (Y/N) -> ");
				char answer = input.next().toLowerCase().charAt(0);
				if(answer=='y'){
					continue L1;
				}else if(answer=='n'){
	...
	public static void loans(){
		L1: do{
			...
			System.out.println("\n");
			System.out.printf("\t\t\t\t %-15s %n", "[5] Main Menu");
			System.out.println("\n");
			int op;
				Scanner input = new Scanner(System.in);
				System.out.print("\t Enter an option to continue -> ");
				...
				case 3 : homeHquityLoan(); break;
				case 4 : carFinance(); break;			
				case 5 : return;
				default : L2:do{
							System.out.println("\t Invalid option");
							System.out.print("\t Do you Want to Exit to Main Menu? (Y/N) -> ");
...
//-------------------------------------------------Tax-----------------------------------------------------------------------------//
	...
	public static void rentTax(){
		L1: do{
			...
			if (rentValue < 100000) {
				...
				System.out.printf("\t\tyour Monthly instalment : %1.2f %n%n", rentTax);
			}
			L2:do{
				System.out.print("\t Do you Want to Exit to Calculate another rent tax? (Y/N) -> ");
				char answer = input.next().toLowerCase().charAt(0);
				if(answer=='y'){
					continue L1;
				}else if(answer=='n'){
	...
	public static void incomeTax(){
		L1: do{
			...
			} else if (income >= 3700000) {incomeTax = 500000 * 0.06 + 500000 * 0.12 + 500000 * 0.18 + 500000 * 0.24 + 500000 * 0.30 + (income - 3700000) * 0.36;}
			System.out.printf("\t\tYou have to pay Payable Tax per year : %1.2f %n%n", incomeTax);

			L2:do{
				System.out.print("\t Do you Want to Exit to Calculate another Income tax? (Y/N) -> ");
				char answer = input.next().toLowerCase().charAt(0);
				if(answer=='y'){
					continue L1;
				}else if(answer=='n'){
	...
	public static void paybleTax(){
		L1: do{
			...
			System.out.printf("\t\tYou have to pay Income Tax per year : %1.2f %n%n", payTax);

			L2:do{
				System.out.print("\t Do you Want to Exit to Calculate another Payable tax? (Y/N) -> ");
				char answer = input.next().toLowerCase().charAt(0);
				if(answer=='y'){
					continue L1;
				}else if(answer=='n'){
	...
	public static void leasing(){
		L1: do{
			...
			L2:do{
				System.out.print("\t Do you Want to Exit to Calculate another Leasing? (Y/N) -> ");
				char answer = input.next().toLowerCase().charAt(0);
				if(answer=='y'){
					continue L1;
				}else if(answer=='n'){
	...
	public static void tax(){
		L1: do{
			...
			System.out.println("\n");
			System.out.printf("\t\t\t\t %-15s %n", "[5] Main Manu");
			System.out.println("\n");
...
//-------------------------------------------------Share Market-----------------------------------------------------------------------------//
	...
	public static void shareMarket(){
			...
			L2:do{
				System.out.print("\t Do you Want to Exit to Calculate another Share Value? (Y/N) -> ");
				char answer = input.next().toLowerCase().charAt(0);
				if(answer=='y'){
					continue L1;
				}else if(answer=='n'){
