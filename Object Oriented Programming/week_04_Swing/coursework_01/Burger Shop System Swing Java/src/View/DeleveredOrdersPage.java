 ...
 * @author ARCH-QS-PC
 */
public class DeleveredOrdersPage extends JFrame {
    ...
    private void loadTable(){
        Order[] orderArray=controller.getOrdersByStatus(1);
        dtm.setRowCount(0);
    ...
    DeleveredOrdersPage(){
        ...
        lblTitle = new JLabel();
        lblTitle.setText("Delevered Orders");
